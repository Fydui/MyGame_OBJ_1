...
public:
    ...
    Q_INVOKABLE Item* AddPixmapItem(String PicPath,float X,float Y,String slotfun=NULL,String down=NULL,ParametersStru *par=nullptr,GraphicsScene *scene=MainScene);
    Q_INVOKABLE Item* AddPixmapItem(Pixmap *pixmap, float X, float Y, String slotfun=NULL, Pixmap *down=nullptr, ParametersStru *par=nullptr, GraphicsScene *scene=MainScene);
    ...
    Q_INVOKABLE EasyThread* StartThread(String slotfun, ParametersStru *par=nullptr, bool track=true);
    Q_INVOKABLE void StopThread(EasyThread *thread);
    Q_INVOKABLE bool ItemColliding(Item* item1, Item* item2);
    Q_INVOKABLE void AnimationRotationItem(Item* item, float set,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationRotationItem(Item* item,SCFun scfun,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationScaleItem(Item* item, float set,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationScaleItem(Item* item,SCFun scfun,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationBlurRadiusItem(Item* item, float set,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationBlurRadiusItem(Item* item,SCFun scfun,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationSetOpacityItem(Item* item, float set,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationSetOpacityItem(Item* item,SCFun scfun,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationMoveItem(Item* item,float X,float Y,int time,String signfun=NULL);
    Q_INVOKABLE void AnimationMoveItem(Item* item,SCFun scfun,int time,String signfun=NULL);
    Q_INVOKABLE void AnimationSetViewCenter(GraphicsView* view,float X,float Y,int time,String signfun=NULL);
    Q_INVOKABLE void AnimationSetViewCenter(GraphicsView* view,SCFun scfun,int time,String signfun=NULL);
    Q_INVOKABLE void AnimationShearItem(Item* item, float fx, float fy, int time, String signfun=NULL);
    Q_INVOKABLE void AnimationShearItem(Item* item,SCFun scfun,int time, String signfun=NULL);
    Q_INVOKABLE void AnimationSetRGBColorItem(Item* item, float R, float G, float B,int times,String signfun=NULL);
    Q_INVOKABLE void AnimationSetRGBColorItem(Item* item,SCFun scfun,int times,String signfun=NULL);
    ...
    Q_INVOKABLE Item* AddPicAnimation(QVector<String> address,int x,int y,int time,String signfun=NULL,bool cycle=true,GraphicsScene *scene=MainScene);
    Q_INVOKABLE Item* AddPicAnimation(QVector<Pixmap*> allpixmap, int x, int y, int time, String signfun=NULL, bool cycle=true, GraphicsScene *scene=MainScene);
    ...
    Q_INVOKABLE void AddKeyEvent(Qt::Key key,String slotfun,ParametersStru *par=nullptr);
    Q_INVOKABLE void DeleteKeyEvent(Qt::Key key);
    Q_INVOKABLE void AddMouseEvent(float MouseX,float MouseY,float fMouseX,float fMouseY,String slotfun,ParametersStru *par=nullptr);
